...
import { PedidosEsperaService } from "src/app/modules/pedidosespera/pedidosespera.service";
import { Subscription } from "rxjs";
import { Constants } from "../../helpers/constats";
import { Notify } from "../../modules/notify/notify";
import { constants } from "buffer";
@Component({
  selector: "app-pedidosespera",
  templateUrl: "./pedidosespera.component.html",
  styleUrls: ["./pedidosespera.component.scss"]
})
export class PedidosEsperaComponent implements OnInit, OnDestroy {
  ...
  constructor(private pedidosesperaService: PedidosEsperaService,private notify: Notify) {
    this.subscriptions = [];
  }
  ...
  ngOnInit() {
    ...
    const getTestSub: Subscription = this.pedidosesperaService
    ...
    const postTestSub: Subscription = this.pedidosesperaService
  ...
  mProcessUnitSerialNumber(data: any) {
    this.pedidosesperaService.ProcessUnitSerialNumber(data).subscribe(Result => {
      console.log(Result);
      if (!Result.success) {
  ...
  mValidatePasswordBarcode(data: any) {
    this.pedidosesperaService.ValidatePasswordBarcode(data).subscribe(Result => {
      console.log(Result);
      document.getElementById('txtPasswordBarcode').removeAttribute('disabled');
      $('#txtPasswordBarcode').val("");
      $('#txtPasswordBarcode').focus();
