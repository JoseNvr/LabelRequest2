...
export class PedidosFinalizadosService {
  ...
  getTest(data: any): Observable<GeneralResponse> {
    return this.http
      .get<GeneralResponse>(PedidosFinalizadosService.ENDPOINT_GET_TEST, {
        params: data
      })
      .pipe();
  }
  ...
  postTest(data: any): Observable<GeneralResponse> {
    return this.http
      .post<GeneralResponse>(PedidosFinalizadosService.ENDPOINT_POST_TEST, data)
      .pipe();
  }
