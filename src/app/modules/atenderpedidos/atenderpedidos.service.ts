...
export class AtenderPedidosService {
  ...
  getTest(data: any): Observable<GeneralResponse> {
    return this.http
      .get<GeneralResponse>(AtenderPedidosService.ENDPOINT_GET_TEST, {
        params: data
      })
      .pipe();
  }
  ...
  postTest(data: any): Observable<GeneralResponse> {
    return this.http
      .post<GeneralResponse>(AtenderPedidosService.ENDPOINT_POST_TEST, data)
      .pipe();
  }
