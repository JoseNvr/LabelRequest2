...
export class CancelarPedidosService {
  ...
  getTest(data: any): Observable<GeneralResponse> {
    return this.http
      .get<GeneralResponse>(CancelarPedidosService.ENDPOINT_GET_TEST, {
        params: data
      })
      .pipe();
  }
  ...
  postTest(data: any): Observable<GeneralResponse> {
    return this.http
      .post<GeneralResponse>(CancelarPedidosService.ENDPOINT_POST_TEST, data)
      .pipe();
  }
