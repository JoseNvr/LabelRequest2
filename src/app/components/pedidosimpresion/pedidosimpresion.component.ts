...
import { PedidosImpresionService } from "src/app/modules/pedidosimpresion/pedidosimpresion.service";
import { Subscription } from "rxjs";
import { Constants } from "../../helpers/constats";
import { Notify } from "../../modules/notify/notify";
import { constants } from "buffer";
@Component({
  selector: "app-pedidosimpresion",
  templateUrl: "./pedidosimpresion.component.html",
  styleUrls: ["./pedidosimpresion.component.scss"]
})
export class PedidosImpresionComponent implements OnInit, OnDestroy {
  ...
  constructor(private pedidosimpresionService: PedidosImpresionService,private notify: Notify) {
    this.subscriptions = [];
  }
  ...
  ngOnInit() {
    ...
    const getTestSub: Subscription = this.pedidosimpresionService
    ...
    const postTestSub: Subscription = this.pedidosimpresionService
  ...
  mProcessUnitSerialNumber(data: any) {
    this.pedidosimpresionService.ProcessUnitSerialNumber(data).subscribe(Result => {
      console.log(Result);
      if (!Result.success) {
  ...
  mValidatePasswordBarcode(data: any) {
    this.pedidosimpresionService.ValidatePasswordBarcode(data).subscribe(Result => {
      console.log(Result);
      document.getElementById('txtPasswordBarcode').removeAttribute('disabled');
      $('#txtPasswordBarcode').val("");
      $('#txtPasswordBarcode').focus();
