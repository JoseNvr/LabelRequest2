...
export class PedidosImpresionService {
  ...
  getTest(data: any): Observable<GeneralResponse> {
    return this.http
      .get<GeneralResponse>(PedidosImpresionService.ENDPOINT_GET_TEST, {
        params: data
      })
      .pipe();
  }
  ...
  postTest(data: any): Observable<GeneralResponse> {
    return this.http
      .post<GeneralResponse>(PedidosImpresionService.ENDPOINT_POST_TEST, data)
      .pipe();
  }
