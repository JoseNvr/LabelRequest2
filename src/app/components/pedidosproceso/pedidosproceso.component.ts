...
import { PedidosProcesoService } from "src/app/modules/pedidosproceso/pedidosproceso.service";
import { Subscription } from "rxjs";
import { Constants } from "../../helpers/constats";
import { Notify } from "../../modules/notify/notify";
import { constants } from "buffer";
@Component({
  selector: "app-pedidosproceso",
  templateUrl: "./pedidosproceso.component.html",
  styleUrls: ["./pedidosproceso.component.scss"]
})
export class PedidosProcesoComponent implements OnInit, OnDestroy {
  ...
  constructor(private pedidosprocesoService: PedidosProcesoService,private notify: Notify) {
    this.subscriptions = [];
  }
  ...
  ngOnInit() {
    ...
    const getTestSub: Subscription = this.pedidosprocesoService
    ...
    const postTestSub: Subscription = this.pedidosprocesoService
  ...
  mProcessUnitSerialNumber(data: any) {
    this.pedidosprocesoService.ProcessUnitSerialNumber(data).subscribe(Result => {
      console.log(Result);
      if (!Result.success) {
  ...
  mValidatePasswordBarcode(data: any) {
    this.pedidosprocesoService.ValidatePasswordBarcode(data).subscribe(Result => {
      console.log(Result);
      document.getElementById('txtPasswordBarcode').removeAttribute('disabled');
      $('#txtPasswordBarcode').val("");
      $('#txtPasswordBarcode').focus();
