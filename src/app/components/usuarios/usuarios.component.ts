...
export class UsuariosComponent implements OnInit, OnDestroy {
  ...
  constructor(private usuariosService: UsuariosService,private notify: Notify) {
    this.subscriptions = [];
  }
  ngOnInit() {
    //Cargar interfaz
    ...
    const getTestSub: Subscription = this.usuariosService
    ...
    const postTestSub: Subscription = this.usuariosService
  ...
  mProcessUnitSerialNumber(data: any) {
    this.usuariosService.ProcessUnitSerialNumber(data).subscribe(Result => {
      console.log(Result);
      if (!Result.success) {
  ...
  mValidatePasswordBarcode(data: any) {
    this.usuariosService.ValidatePasswordBarcode(data).subscribe(Result => {
      console.log(Result);
      document.getElementById('txtPasswordBarcode').removeAttribute('disabled');
      $('#txtPasswordBarcode').val("");
      $('#txtPasswordBarcode').focus();
