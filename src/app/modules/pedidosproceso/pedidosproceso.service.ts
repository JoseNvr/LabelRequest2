...
export class PedidosProcesoService {
  ...
  getTest(data: any): Observable<GeneralResponse> {
    return this.http
      .get<GeneralResponse>(PedidosProcesoService.ENDPOINT_GET_TEST, {
        params: data
      })
      .pipe();
  }
  ...
  postTest(data: any): Observable<GeneralResponse> {
    return this.http
      .post<GeneralResponse>(PedidosProcesoService.ENDPOINT_POST_TEST, data)
      .pipe();
  }
